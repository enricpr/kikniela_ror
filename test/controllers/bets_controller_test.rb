...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { game_id: @bet.game_id, hit: @bet.hit, tip: @bet.tip, user_id: @bet.user_id }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { game_id: @bet.game_id, hit: @bet.hit, tip: @bet.tip, user_id: @bet.user_id }
    assert_redirected_to bet_path(assigns(:bet))
  end
